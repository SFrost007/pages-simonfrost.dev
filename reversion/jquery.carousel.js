		...
		switch (env.params.effect){
			...
			case "no":
				if (env.params.direction == "vertical"){
					...
					env.$elts.content.css("left", -(env.firstItem.outerWidth() * step) + "px");
				}
				break;
			...
			case "fade":
				if (env.params.direction == "vertical"){
					...
					env.$elts.content.hide().css("left", -(env.firstItem.outerWidth() * step) + "px").fadeIn(env.params.animSpeed);
				}
				break;
			...
			default:
				if (env.params.direction == "vertical"){
					...
					env.$elts.content.stop().animate({
						left : -(env.firstItem.outerWidth() * step) + "px"
					}, env.params.animSpeed, env.params.slideEasing);
				}
				break;
		}
		
		env.$elts.content.width(env.firstItem.outerWidth() * env.steps.count);
